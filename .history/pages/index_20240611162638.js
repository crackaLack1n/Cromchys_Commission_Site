          ...
          <div className={styles.containerRight}>
            <div className={styles.contentRight}>
              <div className={styles.section}>
                ...
                <p>hihihihi im Cromchy or Lack1n (on Discord) im a digital artist but also a UI/UX designer and web developer (dont ask me about JavaScript i still dont know lololol). 
                  Huge fan of RPGs
                </p>
              </div>
              <div className={styles.section}>
